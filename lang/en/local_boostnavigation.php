...
$string['setting_newfeaturesmycoursenode_desc'] = 'When enabled will add a Past Dropdown into My Courses as well as include future courses as apart of current. Future courses will be visablably different through changed opacity. Color coordinated badges are also added to tell which term the course takes place in.';
