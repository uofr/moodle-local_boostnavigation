...
$string['setting_currentsem']= 'Set current semester';
$string['setting_currentsem_desc']='Enter current semester in format of yyyytt where Winter term is 10, Spring/Summer is 20 and Fall is 30. Example: 202110.';
...
$string['setting_newfeaturesmycoursenode'] = 'Add Past Courses to My Courses Node';
$string['setting_newfeaturesmycoursenode_desc'] = 'When enabled new sections will be added into My Courses, these include a Past Courses dropdown, semester labels, hidden courses, and future courses. Future courses will be visibly different via changed opacity. Colour coordinated semester labels are used to tell which term the course takes place in. Hidden courses will be displayed for students, however will be unaccessible. The current semester (above) needs to be set for changes to occur even when this setting is enabled.';
...
$string['settingspage_currentsem'] = 'Custom UofR Settings';
